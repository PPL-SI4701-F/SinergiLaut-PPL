...
describe('FR-32: Pembuatan Pencairan dan Validasi Saldo', () => {
    ...
    it('FR 32 - TC 13 - Harus gagal dan menampilkan error jika nominal pencairan melebihi saldo tersedia', () => {
        ...
        cy.get('input[name="amount"]').type('{selectAll}{backspace}1000000000'); // Asumsi jauh lebih besar dari saldo
