...
describe('FR-32: Validasi Laporan oleh Admin (/admin/reports)', () => {
    ...
    // ─────────────────────────────────────────────
    it('FR 32 - Harus memvalidasi laporan submitted dan mengubah status menjadi Divalidasi - TC 09', () => {
        cy.contains('tr', /Menunggu Review/i).first().contains('button', /Validasi/i).click();
        ...
        cy.contains('tr', /Divalidasi/i).should('be.visible');
    });
