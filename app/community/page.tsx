...
const communityPageStyles = `
        ...
        .comm-hero-overlay { position:absolute; inset:0; background:linear-gradient(160deg,rgba(3,22,48,0.9) 0%,rgba(4,55,82,0.75) 50%,rgba(3,40,60,0.92) 100%); }
        .comm-hero-particles { position:absolute; inset:0; background-image:radial-gradient(circle,rgba(103,232,249,0.12) 1px,transparent 1px),radial-gradient(circle,rgba(165,243,252,0.07) 1px,transparent 1px); background-size:55px 55px,28px 28px; background-position:0 0,14px 14px; animation:commParticleDrift 25s linear infinite; pointer-events:none; }
        @keyframes commParticleDrift { from{transform:translateY(0)} to{transform:translateY(-60px)} }
        .comm-hero-content { position:relative; z-index:10; max-width:1000px; width:100%; }
        .comm-hero-badge { display:inline-flex; align-items:center; gap:0.5rem; background:rgba(103,232,249,0.12); backdrop-filter:blur(10px); border:1px solid rgba(103,232,249,0.28); color:#a5f3fc; font-size:0.8125rem; font-weight:600; letter-spacing:0.06em; text-transform:uppercase; padding:0.45rem 1.25rem; border-radius:9999px; margin-bottom:2rem; }
        .comm-hero-title { font-size:clamp(2.25rem,5.5vw,4rem); font-weight:900; color:white; line-height:1.1; letter-spacing:-0.03em; margin-bottom:1.5rem; }
        .comm-shimmer { background:linear-gradient(90deg,#67e8f9,#a5f3fc,#67e8f9); background-size:200%; -webkit-background-clip:text; -webkit-text-fill-color:transparent; animation:commShimmer 4s linear infinite; }
        @keyframes commShimmer { from{background-position:0% center} to{background-position:200% center} }
        .comm-hero-desc { font-size:1.0625rem; color:rgba(255,255,255,0.72); line-height:1.75; max-width:580px; margin:0 auto 2.5rem; }
        .comm-wave { position:absolute; bottom:-2px; left:0; right:0; z-index:5; line-height:0; }

        /* ── Stats Bar ── */
        .comm-stats-wrapper { position:relative; z-index:20; margin-top:3.5rem; }
        .comm-stats-bar { background:linear-gradient(135deg,#06958a,#0e7268); border-radius:1.5rem; box-shadow:0 16px 40px rgba(6,149,138,0.25); padding:2.5rem 2rem; position:relative; overflow:hidden; max-width:1000px; margin:0 auto; }
        @media(max-width:640px){ .comm-stats-bar{padding:1.5rem 1rem;border-radius:1.25rem;} }
        .comm-stats-inner { position:relative; z-index:2; max-width:800px; margin:0 auto; display:grid; grid-template-columns:repeat(3,1fr); gap:1.5rem; }
        @media(max-width:640px){ .comm-stats-inner{grid-template-columns:1fr;gap:1.25rem;} }
        ...
        @media(max-width:640px){ .comm-stat-item{border-right:none;border-bottom:1px solid rgba(255,255,255,0.15);padding-bottom:1.25rem;} .comm-stat-item:last-child{border-bottom:none;padding-bottom:0;} }
        .comm-stat-icon-wrap { width:46px; height:46px; background:rgba(255,255,255,0.12); border-radius:0.875rem; display:flex; align-items:center; justify-content:center; margin:0 auto 0.875rem; backdrop-filter:blur(4px); }
        ...
        .comm-eyebrow { display:inline-flex; align-items:center; gap:0.5rem; font-size:0.8rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:#06958a; margin-bottom:0.875rem; }
        .comm-eyebrow-dot { width:6px; height:6px; border-radius:50%; background:#06958a; }
        .comm-section-title { font-size:clamp(1.75rem,3.5vw,2.625rem); font-weight:800; color:#0e2a3a; line-height:1.2; letter-spacing:-0.02em; margin-bottom:1rem; }
        .comm-section-desc { font-size:1.0625rem; color:#475569; line-height:1.7; max-width:580px; }

        /* ── Register CTA ── */
        .comm-register-grid { display:grid; gap:4rem; grid-template-columns:1fr; align-items:center; }
        ...
        .comm-req-item { display:flex; align-items:flex-start; gap:1rem; padding:1.25rem; background:white; border-radius:1rem; border:1.5px solid rgba(6,149,138,0.1); box-shadow:0 2px 8px rgba(0,0,0,0.03); transition:all 0.2s ease; }
        .comm-req-item:hover { transform:translateX(4px); box-shadow:0 4px 16px rgba(6,149,138,0.1); }
        .comm-req-icon { width:42px; height:42px; flex-shrink:0; background:linear-gradient(135deg,rgba(14,77,109,0.1),rgba(6,149,138,0.12)); border-radius:0.75rem; display:flex; align-items:center; justify-content:center; }
        ...
        .comm-register-img { position:relative; border-radius:1.5rem; overflow:hidden; height:480px; box-shadow:0 20px 60px rgba(0,0,0,0.15); }
        .comm-register-floating { position:absolute; bottom:-1.5rem; left:-1.5rem; z-index:10; background:white; border-radius:1.25rem; padding:1.25rem 1.5rem; box-shadow:0 8px 30px rgba(6,149,138,0.15); border:1.5px solid rgba(6,149,138,0.12); display:flex; align-items:center; gap:1rem; }
        .comm-register-floating-icon { width:44px; height:44px; border-radius:0.875rem; background:rgba(22,163,74,0.1); display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .comm-register-cta { display:inline-flex; align-items:center; gap:0.5rem; padding:0.875rem 2rem; background:linear-gradient(135deg,#0e4d6d,#06958a); color:white; border-radius:0.875rem; font-size:0.9375rem; font-weight:700; text-decoration:none; transition:all 0.25s ease; box-shadow:0 4px 20px rgba(6,149,138,0.3); }
        .comm-register-cta:hover { transform:translateY(-2px); box-shadow:0 8px 30px rgba(6,149,138,0.4); }

        /* ── Benefits ── */
        .comm-benefits-grid { display:grid; gap:1.5rem; grid-template-columns:1fr; }
        ...
        .comm-benefit-card { background:white; border-radius:1.25rem; padding:2rem; border:1.5px solid rgba(0,0,0,0.06); box-shadow:0 2px 8px rgba(0,0,0,0.04); transition:all 0.3s ease; position:relative; overflow:hidden; }
        .comm-benefit-card::after { content:''; position:absolute; bottom:0; left:0; right:0; height:3px; opacity:0; transition:opacity 0.3s; }
        ...
        .comm-search-bar { background:linear-gradient(135deg,#06958a,#0e7268); border-radius:1.5rem; box-shadow:0 16px 40px rgba(6,149,138,0.25); padding:2rem 1.5rem; position:relative; max-width:1000px; margin:0 auto; }
        @media(max-width:640px){ .comm-search-bar{padding:1.25rem 1rem;border-radius:1.25rem;} }
        ...
        @media(max-width:640px){ .comm-search-inner{flex-direction:column;align-items:stretch;gap:0.75rem;} }
        .comm-search-input-wrap { position:relative; flex:1; min-width:240px; }
        @media(max-width:640px){ .comm-search-input-wrap{min-width:0;} }
        ...
        .comm-search-input { width:100%; padding:0.75rem 1rem 0.75rem 2.75rem; background:rgba(255,255,255,0.12); border:1.5px solid rgba(255,255,255,0.22); border-radius:0.875rem; color:white; font-size:0.9375rem; outline:none; font-family:inherit; transition:all 0.2s ease; }
        ...
        .comm-dropdown-btn { display:inline-flex; align-items:center; gap:0.5rem; padding:0.75rem 1.125rem; background:rgba(255,255,255,0.1); border:1.5px solid rgba(255,255,255,0.22); border-radius:0.875rem; color:white; font-size:0.875rem; font-weight:600; cursor:pointer; font-family:inherit; transition:all 0.2s ease; white-space:nowrap; }
        .comm-dropdown-btn:hover { background:rgba(255,255,255,0.18); }
        .comm-dropdown-menu { position:absolute; top:calc(100% + 0.5rem); right:0; background:white; border-radius:0.875rem; box-shadow:0 8px 30px rgba(0,0,0,0.15); overflow:hidden; z-index:50; min-width:180px; border:1px solid rgba(0,0,0,0.06); }
        .comm-dropdown-item { display:block; width:100%; text-align:left; padding:0.625rem 1rem; font-size:0.875rem; color:#374151; background:transparent; border:none; cursor:pointer; font-family:inherit; transition:background 0.15s; }
        ...
        /* ── Community Grid ── */
        .comm-grid { display:grid; gap:1.5rem; grid-template-columns:1fr; }
        ...
        .comm-card { background:white; border-radius:1.25rem; overflow:hidden; border:1.5px solid rgba(0,0,0,0.06); box-shadow:0 2px 8px rgba(0,0,0,0.04); transition:all 0.3s ease; display:flex; flex-direction:column; }
        ...
        .comm-card-avatar { width:56px; height:56px; border-radius:0.875rem; overflow:hidden; background:linear-gradient(135deg,rgba(14,77,109,0.08),rgba(6,149,138,0.1)); flex-shrink:0; position:relative; border:2px solid rgba(6,149,138,0.12); }
        ...
        .comm-card-verified { display:inline-flex; align-items:center; gap:0.35rem; background:rgba(6,149,138,0.1); color:#06958a; font-size:0.7rem; font-weight:700; padding:0.2rem 0.625rem; border-radius:9999px; text-transform:uppercase; letter-spacing:0.04em; margin-bottom:0.5rem; }
        ...
        .comm-card-tag { font-size:0.7rem; font-weight:600; color:#0e4d6d; background:rgba(14,77,109,0.08); border-radius:9999px; padding:0.2rem 0.625rem; text-transform:capitalize; }
        .comm-card-meta { display:flex; align-items:center; gap:1rem; font-size:0.8125rem; color:#64748b; margin-bottom:1rem; }
        .comm-card-btn { display:flex; align-items:center; justify-content:center; gap:0.5rem; padding:0.7rem 1rem; background:transparent; color:#0e4d6d; border:1.5px solid rgba(14,77,109,0.2); border-radius:0.75rem; font-size:0.875rem; font-weight:600; text-decoration:none; transition:all 0.2s ease; margin-top:auto; }
        ...
        .comm-empty-icon { width:72px; height:72px; background:linear-gradient(135deg,rgba(14,77,109,0.08),rgba(6,149,138,0.1)); border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 1.25rem; }

        /* ── CTA ── */
        .comm-cta { position:relative; overflow:hidden; background:linear-gradient(135deg,#031c36 0%,#043752 45%,#032836 100%); padding:5.5rem 1.5rem; text-align:center; }
        .comm-cta-bg { position:absolute; inset:0; background-image:radial-gradient(circle,rgba(103,232,249,0.07) 1px,transparent 1px); background-size:40px 40px; pointer-events:none; }
        .comm-cta-glow { position:absolute; width:600px; height:400px; border-radius:50%; background:radial-gradient(ellipse,rgba(6,149,138,0.18),transparent 70%); top:-100px; left:50%; transform:translateX(-50%); pointer-events:none; }
        .comm-cta-inner { position:relative; z-index:1; max-width:660px; margin:0 auto; }
        .comm-cta-badge { display:inline-flex; align-items:center; gap:0.5rem; background:rgba(103,232,249,0.1); border:1px solid rgba(103,232,249,0.22); color:#a5f3fc; font-size:0.8125rem; font-weight:600; letter-spacing:0.05em; text-transform:uppercase; padding:0.4rem 1.25rem; border-radius:9999px; margin-bottom:1.5rem; }
        .comm-cta-title { font-size:clamp(1.75rem,4vw,3rem); font-weight:900; color:white; letter-spacing:-0.02em; line-height:1.2; margin-bottom:1rem; }
        ...
        .comm-cta-btn-primary { padding:0.9rem 2.25rem; background:linear-gradient(135deg,#06958a,#04756c); color:white; border:none; border-radius:0.875rem; font-size:0.9375rem; font-weight:700; text-decoration:none; display:inline-flex; align-items:center; gap:0.5rem; transition:all 0.25s ease; box-shadow:0 4px 20px rgba(6,149,138,0.4); }
        ...
        <section className="comm-hero">
          ...
          <div className="comm-hero-content">
            ...
            <h1 className="comm-hero-title">
              Komunitas <span className="comm-shimmer">Konservasi</span> Laut
            </h1>
        ...
        <section className="comm-section-alt">
          <div className="comm-container">
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              <div className="comm-eyebrow" style={{ justifyContent: "center", margin: "0 auto 0.875rem" }}>
                <span className="comm-eyebrow-dot" /> Keuntungan Bergabung
              </div>
              <h2 className="comm-section-title">Mengapa Daftarkan Komunitas Anda?</h2>
              <p className="comm-section-desc" style={{ margin: "0 auto" }}>
        ...
        <section className="comm-cta">
          ...
          <div className="comm-cta-inner">
            <div className="comm-cta-badge">
              <Sparkles style={{ width: 12, height: 12 }} /> Bergabung Sekarang
            </div>
            <h2 className="comm-cta-title">Siap Menumbuhkan Dampak Anda?</h2>
            <p className="comm-cta-desc">
              Bergabunglah dengan jaringan komunitas konservasi kami dan akses alat untuk menjangkau lebih banyak relawan, mengumpulkan donasi, dan mengembangkan upaya konservasi laut Anda.
            </p>
